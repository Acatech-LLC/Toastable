...
class ToastableNotifier
{
    ...
    {
        $this->session->toastable('toastable_notification.message', $message);
        $this->session->toastable('toastable_notification.link', $link);
        $this->session->toastable('toastable_notification.type', $type);
